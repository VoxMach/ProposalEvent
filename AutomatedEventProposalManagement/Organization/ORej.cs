...
{
    public partial class ORej : Form
    {
                    ...
                    if (home.idor.Equals(ids))
                    {
                        if (find.Value.status.Equals("Rejected") || find.Value.approver == "Rejected"
                            || find.Value.incharge == "Rejected" || find.Value.org_adviser_status == "Rejected" ||
                             ...
                             || find.Value.status.Equals("Denied") || find.Value.approver == "Denied"
                            || find.Value.incharge == "Denied" || find.Value.org_adviser_status == "Denied" ||
                             find.Value.org_dean_status == "Denied" || find.Value.org_president_status == "Denied")
                        {
